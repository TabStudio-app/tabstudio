...
const PDF_FOOTER_BRANDING_TEXT = "write tabs, save tabs, play tabs.";
...
function resolvePlaceholderGuardPath(targetPath, routeState) {
  ...
  if (path === "/editor" || path === "/projects" || path === "/export") {
    if (!isAuthenticated) return "/signup";
    if (!hasPaidTier) return hasCheckoutIntent ? "/checkout" : "/membership";
    if (!isProfileComplete) return "/profile-setup";
    return path;
...
function buildPdfPageLayout({
  ...
  const pages = contentPages.map((pageData, pageIndex) => {
    ...
    return {
      contentLines,
      footerLeft: `tabstudio.app • ${PDF_FOOTER_BRANDING_TEXT}`,
      ...
      >
        ...
        <div style={siteHeaderRightGroupStyle}>
          ...
          <div ref={saveProjectsGroupRef} style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            {!projectsLibraryOpen && !exportModalOpen && editorSaveStatus ? (
              <div
                style={{
                  fontSize: 12,
                  fontWeight: 800,
