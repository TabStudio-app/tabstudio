...
function normalizeUserState(rawState) {
  ...
  const plan =
    rawState.planType === "solo" || rawState.planType === "band" || rawState.planType === "creator"
      ? rawState.planType
      : null;
  const hasMembership = Boolean(rawState.hasMembership);
  const everHadMembership = Boolean(rawState.everHadMembership || hasMembership || plan);
  return {
...
function siteHeaderBarStyle(theme) {
  return {
    ...
    gap: SITE_HEADER_LAYOUT.gap,
    minHeight: SITE_HEADER_LAYOUT.minHeight,
    position: "sticky",
    top: 0,
    zIndex: 50,
    padding: `${SITE_HEADER_LAYOUT.paddingY}px ${SITE_HEADER_LAYOUT.paddingX}px`,
    background: theme.bg,
...
const siteHeaderRightGroupStyle = {
  display: "flex",
  gap: SITE_HEADER_LAYOUT.rightGap,
  alignItems: "center",
  flexWrap: "wrap",
};

const siteHeaderLogoButtonStyle = {
  width: SITE_HEADER_LAYOUT.logoWidth,
  height: SITE_HEADER_LAYOUT.logoHeight,
  overflow: "hidden",
  borderRadius: 4,
  flexShrink: 0,
  position: "relative",
...
function HelpHubPage({
  ...
  useEffect(() => {
    if (!tabbySpeechTrigger || activeHelpSection !== "support") return undefined;
  ...
  }, [tabbySpeechTrigger, activeHelpSection]);
  ...
  return (
    ...
    >
      <div
        style={siteHeaderBarStyle(HELP_THEME)}
      >
        <div style={siteHeaderLeftGroupStyle}>
          <button
            className="tabstudio-brand-logo-btn"
            type="button"
          ...
          <div style={siteHeaderSloganStyle(HELP_THEME.text, 0.75)}>
            Tabs, simplified.
          </div>
        </div>
            ...
            {filteredFaqItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span>{item.q}</span>
                    <span style={{ fontSize: 12, opacity: 0.95, color: HELP_THEME.text }}>{open ? "▲" : "▼"}</span>
                  </button>
                  {open && (
                    <div
                      style={{
...
function MembershipPage({ onBack, onGoSettings, onSelectPlan }) {
  const [themeRefresh, setThemeRefresh] = useState(0);
  ...
  return (
    ...
    >
      <div
        style={siteHeaderBarStyle(MEMBERSHIP_THEME)}
      >
        <div style={siteHeaderLeftGroupStyle}>
          <button
            className="tabstudio-brand-logo-btn"
          ...
          <div style={siteHeaderSloganStyle(MEMBERSHIP_THEME.text, 0.75)}>
            Tabs, simplified.
          </div>
        </div>
        <div style={siteHeaderRightGroupStyle}>
          ...
          >
            ...
            >
              ...
              {plans.map((plan) => {
                ...
                const cardBorderColor = isBandPlan ? withAlpha(TABBY_ASSIST_MINT, 0.4) : MEMBERSHIP_THEME.border;
                const cardShadow = isHovered
                  ...
                  : "none";
                const ctaMintActive = isHovered || isButtonHovered || isBandPlan;
                const ctaInteractive = isHovered || isButtonHovered;
                const ctaBorderColor = ctaMintActive ? withAlpha(TABBY_ASSIST_MINT, 0.7) : MEMBERSHIP_THEME.border;
                const ctaBackground = ctaMintActive
                  ? TABBY_ASSIST_MINT
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  display: "grid",
                  gap: 16,
                  minHeight: membershipFeatureNarrow ? 360 : 430,
              ...
              >
                ...
                >
                  ...
                  <div style={{ color: MEMBERSHIP_THEME.textFaint, lineHeight: 1.52, fontSize: 15, display: "grid", gap: 10 }}>
                ...
                <div
                  style={{
                    ...
                    minHeight: membershipFeatureNarrow ? 220 : 255,
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
                    ...
                    gap: 10,
                    padding: 12,
                    marginTop: membershipFeatureNarrow ? 2 : 6,
                    opacity: membershipSpotlightVisible ? 1 : 0,
                    transform: `translateY(${membershipSpotlightVisible ? 0 : 4}px)`,
                    transition: "opacity 180ms ease, transform 180ms ease",
                  }}
                >
                  <div
                    style={{
                      ...
                      border: `1px solid ${MEMBERSHIP_THEME.border}`,
                      overflow: "hidden",
                      minHeight: membershipFeatureNarrow ? 170 : 220,
                      aspectRatio: "16 / 9",
...
function SignupPage({ onBack, onContinue, selectedPlan = "solo", selectedBillingCycle = "monthly" }) {
  const [themeRefresh, setThemeRefresh] = useState(0);
  ...
  const [signupHeaderHoverBtn, setSignupHeaderHoverBtn] = useState("");
  const [signupHeaderPressedBtn, setSignupHeaderPressedBtn] = useState("");
  ...
  const passwordsMatch = String(password || "").length > 0 && String(confirmPassword || "").length > 0 && password === confirmPassword;
  const passwordsMismatch = String(confirmPassword || "").length > 0 && password !== confirmPassword;
  const canContinue =
  ...
  const handleContinue = (e) => {
    ...
    if (Object.keys(nextErrors).length) return;
    onContinue?.({ email: cleanEmail, password, selectedPlan, selectedBillingCycle: activeBillingCycle });
  };
  ...
  return (
    ...
    >
      <div style={siteHeaderBarStyle(SIGNUP_THEME)}>
        <div style={siteHeaderLeftGroupStyle}>
          <button
            className="tabstudio-brand-logo-btn"
            type="button"
          ...
          <div style={siteHeaderSloganStyle(SIGNUP_THEME.text, 0.75)}>
            Tabs, simplified.
          </div>
        </div>
        <button
          type="button"
          onClick={onBack}
          onMouseEnter={() => setSignupHeaderHoverBtn("back")}
          onMouseLeave={() => setSignupHeaderHoverBtn((prev) => (prev === "back" ? "" : prev))}
          onFocus={() => setSignupHeaderHoverBtn("back")}
          onBlur={() => setSignupHeaderHoverBtn((prev) => (prev === "back" ? "" : prev))}
          onPointerDown={() => setSignupHeaderPressedBtn("back")}
          onPointerUp={() => setSignupHeaderPressedBtn("")}
          onPointerCancel={() => setSignupHeaderPressedBtn("")}
          style={siteHeaderEditorLinkStyle(SIGNUP_THEME, { hovered: signupHeaderHoverBtn === "back" })}
        >
          Editor
        </button>
      </div>
          ...
          <div style={{ display: "grid", gap: 14, alignContent: "center", justifyItems: "center", minWidth: 0 }}>
            ...
            >
              <div style={{ display: "grid", gap: 10, textAlign: "center" }}>
                ...
                <div style={{ color: withAlpha(SIGNUP_THEME.text, 0.76), fontSize: 16, fontWeight: 700 }}>
                  Set up your account to continue to checkout.
                </div>
              </div>
              ...
              <form onSubmit={handleContinue} style={{ display: "grid", gap: 14 }}>
                <div style={{ display: "grid", gap: 7 }}>
                  ...
                  <input
                    ...
                    onBlur={() => setSignupFocusedField((prev) => (prev === "email" ? "" : prev))}
                ...
                <div style={{ display: "grid", gap: 7 }}>
                  ...
                  <div style={{ position: "relative" }}>
                    <input
                      ...
                      onBlur={() => setSignupFocusedField((prev) => (prev === "password" ? "" : prev))}
                ...
                <div style={{ display: "grid", gap: 7 }}>
                  <label style={{ fontSize: 13, color: SIGNUP_THEME.textFaint, fontWeight: 800 }}>Confirm Password</label>
                  <div style={{ position: "relative" }}>
                    <input
                      ...
                      onBlur={() => setSignupFocusedField((prev) => (prev === "confirmPassword" ? "" : prev))}
                  ...
                  {passwordsMismatch ? (
                    <div style={{ fontSize: 12, color: "#FF6E7A", fontWeight: 800 }}>Passwords do not match</div>
                  ) : passwordsMatch ? (
                    <div style={{ fontSize: 12, color: "#34d399", fontWeight: 800 }}>✓ Passwords match</div>
                  ) : errors.confirmPassword ? (
                    <div style={{ fontSize: 12, color: "#FF6E7A", fontWeight: 800 }}>{errors.confirmPassword}</div>
                  ) : null}
                </div>
                <button
                  type="submit"
...
function SigninPage({ onBack, onAuthSuccess, onGoMembership }) {
  const [themeRefresh, setThemeRefresh] = useState(0);
  ...
  const THEME = useMemo(() => ({ ...DARK_THEME, accent }), [accent]);
    ...
    >
      <div style={siteHeaderBarStyle(THEME)}>
        <div style={siteHeaderLeftGroupStyle}>
          ...
          <div style={siteHeaderSloganStyle(THEME.text, 0.75)}>
            Tabs, simplified.
          </div>
        </div>
        <button
...
function CheckoutPlaceholderPage({
  onBack,
  onChangePlan,
  ...
  const [themeRefresh, setThemeRefresh] = useState(0);
  const [checkoutHeaderHoverBtn, setCheckoutHeaderHoverBtn] = useState("");
    ...
    >
      <div style={siteHeaderBarStyle(THEME)}>
        ...
        <button
          type="button"
          onClick={onBack}
          onMouseEnter={() => setCheckoutHeaderHoverBtn("editor")}
          onMouseLeave={() => setCheckoutHeaderHoverBtn((prev) => (prev === "editor" ? "" : prev))}
          onFocus={() => setCheckoutHeaderHoverBtn("editor")}
          onBlur={() => setCheckoutHeaderHoverBtn((prev) => (prev === "editor" ? "" : prev))}
          style={siteHeaderEditorLinkStyle(THEME, { hovered: checkoutHeaderHoverBtn === "editor" })}
        >
          Editor
        </button>
      </div>
          ...
          <div style={{ display: "grid", gap: 14, alignContent: "center", justifyItems: "center", minWidth: 0 }}>
            ...
            >
              <div style={{ display: "grid", gap: 10, textAlign: "center" }}>
                ...
                <div style={{ color: withAlpha(THEME.text, 0.76), fontSize: 16, fontWeight: 700 }}>
                  Stripe integration will be added here soon.
                </div>
              </div>
              ...
              <div
                style={{
                  ...
                  background: "rgba(18,18,18,0.95)",
                  boxShadow: "0 0 0 1px rgba(46,204,113,0.15), 0 8px 30px rgba(46,204,113,0.08)",
                  overflow: "hidden",
                }}
              >
                <div style={{ padding: "12px 12px 10px", display: "grid", gap: 10 }}>
                  <div style={{ display: "grid", gap: 2 }}>
                    <div style={{ fontSize: 12, fontWeight: 900, color: THEME.textFaint, letterSpacing: "0.06em", textTransform: "uppercase" }}>
                      Selected plan
                    </div>
                    <div style={{ fontSize: 22, fontWeight: 900, lineHeight: 1.12 }}>{planMeta.label}</div>
                  ...
                  >
                    ...
                    >
                      {selectedPlanHighlights.map((item) => (
                        <div key={item} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: THEME.textFaint, fontWeight: 700 }}>
...
function ProfileSetupPage({ onBackToEditor, onSaveProfile, userState }) {
  const [themeRefresh, setThemeRefresh] = useState(0);
  const [profileHeaderHoverBtn, setProfileHeaderHoverBtn] = useState("");
  ...
  const [birthday, setBirthday] = useState(() => String(userState?.profile?.birthday || ""));
  ...
  const birthdayInputStyle = {
    ...inputStyle("birthday"),
    background: isDark ? "rgba(18,18,18,0.95)" : inputStyle("birthday").background,
    border: profileFocusedField === "birthday" ? "1px solid rgba(66,201,149,0.6)" : inputStyle("birthday").border,
    color: isDark ? "#ffffff" : inputStyle("birthday").color,
    boxShadow: profileFocusedField === "birthday" ? "0 0 0 2px rgba(66,201,149,0.15)" : inputStyle("birthday").boxShadow,
  ...
  const canContinueStep1 =
    String(displayName || "").trim().length > 0 && String(gender || "").trim().length > 0 && String(birthday || "").trim().length > 0;
    ...
    >
      <div style={siteHeaderBarStyle(THEME)}>
        ...
        <button
          type="button"
          onClick={handleLockedExit}
          onMouseEnter={() => setProfileHeaderHoverBtn("editor")}
          onMouseLeave={() => setProfileHeaderHoverBtn((prev) => (prev === "editor" ? "" : prev))}
          onFocus={() => setProfileHeaderHoverBtn("editor")}
          onBlur={() => setProfileHeaderHoverBtn((prev) => (prev === "editor" ? "" : prev))}
          style={siteHeaderEditorLinkStyle(THEME, { hovered: profileHeaderHoverBtn === "editor" })}
        >
          Editor
        </button>
      </div>
            ...
            >
              <div style={{ display: "grid", gap: 8, textAlign: "center" }}>
                ...
                <div style={{ color: withAlpha(THEME.text, 0.76), fontSize: 15, fontWeight: 700 }}>
                  {onboardingStep === 1
                    ? "Add your basic details so your account is ready to go."
                    : onboardingStep === 2
              ...
              {onboardingStep === 1 && (
                <div style={{ display: "grid", gap: 12 }}>
                  <div style={{ display: "grid", gap: 8 }}>
                    <div style={{ fontSize: 13, fontWeight: 800, color: THEME.textFaint }}>Profile picture (optional)</div>
                    <div
                      role="button"
                      tabIndex={0}
                    ...
                    >
                      ...
                      >
                        {avatarDataUrl ? (
                          ...
                          <AvatarSilhouetteIcon size={18} strokeWidth={1.8} color={THEME.textFaint} />
                        )}
                      </div>
                      <div style={{ display: "grid", gap: 2 }}>
                        <div style={{ fontSize: 14, fontWeight: 800 }}>Drag and drop, or click to upload</div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 10 }}>
                    <div style={{ display: "grid", gap: 6 }}>
                      <label style={{ fontSize: 13, fontWeight: 800, color: THEME.textFaint }}>Full Name</label>
                      <input
                        type="text"
                        value={displayName}
                    ...
                    <div style={{ display: "grid", gap: 6 }}>
                      <label style={{ fontSize: 13, fontWeight: 800, color: THEME.textFaint }}>Gender</label>
                      <select
                        value={gender}
                  ...
                  <div style={{ display: "grid", gap: 6 }}>
                    <label style={{ fontSize: 13, fontWeight: 800, color: THEME.textFaint }}>Birthday</label>
                    <input
                      type="date"
                      value={birthday}
                      ...
                      onBlur={() => {
                        setProfileFocusedField((prev) => (prev === "birthday" ? "" : prev));
                      }}
              ...
              <div style={{ display: "grid", gap: 8, justifyItems: "end" }}>
                {!canAdvance ? (
                  <div style={{ fontSize: 12, color: THEME.textMuted, fontWeight: 700 }}>
                    {onboardingStep === 1
                      ? "Please complete display name, gender, and birthday."
                      : onboardingStep === 2
          ...
          >
            ...
            >
              <span style={{ whiteSpace: "pre-line" }}>
                {"Hey! Welcome to the TabStudio family 🎸\nLet’s get your profile set up so everything works just right."}
              </span>
            </TabbySpeechBubble>
            <div
              style={{
...
function SuccessPage({ onBackToEditor, onGoBilling, selectedPlan = "solo" }) {
  const [themeRefresh, setThemeRefresh] = useState(0);
  const getSystemTheme = useCallback(() => {
    if (typeof window === "undefined" || typeof window.matchMedia !== "function") return "light";
    return window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light";
...
export default function App() {
  ...
  const helpSupportEverPaidSubscriber = Boolean(userState?.everHadMembership || userState?.hasMembership || userState?.planType);
...
function EditorApp({ navigateTo, pendingOpenPanel = "", onPendingPanelHandled, userState }) {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .tab-grid-cell-button:hover {
        border-color: ${withAlpha(THEME.accent, 0.46)} !important;
        background: ${withAlpha(THEME.accent, isDarkMode ? 0.1 : 0.06)} !important;
        box-shadow: 0 0 0 1px ${withAlpha(THEME.accent, isDarkMode ? 0.18 : 0.12)} !important;
        transform: none !important;
      }
      .tab-grid-cell-button[data-empty="true"]:hover {
        border-color: ${withAlpha(THEME.accent, 0.56)} !important;
        background: ${withAlpha(THEME.accent, isDarkMode ? 0.14 : 0.09)} !important;
        box-shadow: 0 0 0 1px ${withAlpha(THEME.accent, isDarkMode ? 0.2 : 0.14)} !important;
      }
      .tab-grid-cell-button[data-column-selector="true"]:hover {
        border-color: ${withAlpha(THEME.accent, 0.58)} !important;
        background: ${withAlpha(THEME.accent, isDarkMode ? 0.15 : 0.1)} !important;
        box-shadow: 0 0 0 1px ${withAlpha(THEME.accent, isDarkMode ? 0.22 : 0.15)} !important;
      }
      .tab-grid-cell-button:active {
        border-color: var(--tabstudio-interact-hover-border) !important;
        background: ${withAlpha(THEME.accent, isDarkMode ? 0.16 : 0.11)} !important;
        box-shadow: 0 0 0 2px var(--tabstudio-interact-active-ring) !important;
        transform: none !important;
      }
      ...
      .tab-grid-cell-button[data-replay-active="true"]:hover {
        border-color: var(--tabstudio-interact-selected-border) !important;
        background: ${withAlpha(THEME.accent, isDarkMode ? 0.22 : 0.15)} !important;
        box-shadow: 0 0 0 2px var(--tabstudio-interact-selected-ring) !important;
      }
  ...
  const accountAvatarDataUrl = String(userState?.profile?.avatarDataUrl || "");
...
const editingCellRef = useRef(null); // tracks the cell for the current typing session
  ...
  function handleSaveTabClick() {
    ...
    const isCreatingNewSong = !existingSongSnapshot;
...
function fillSelectedColumnWith(value) {
  ...
  const showMembershipGateToast = useCallback(
    (feature = "save") => {
      ...
      } else if (feature === "creator-export" || feature === "export-image" || feature === "tap-sync") {
        next = {
          message: "Become a member to export clean PDF or PNG tabs.",
          cta: "Become a Member",
        };
      ...
      if (next && showGridTabbyOnboarding) {
    ...
    [markMeaningfulEditorInteraction, userPlanType, showGridTabbyOnboarding]
  );
  ...
  const handleGridTabbySingleClick = useCallback(() => {
    if (gridTabbyHidden || gridTabbyHiding) return;
    if (gridTabbyClickTimerRef.current) {
      window.clearTimeout(gridTabbyClickTimerRef.current);
      gridTabbyClickTimerRef.current = null;
    ...
    gridTabbyClickTimerRef.current = window.setTimeout(() => {
      openGridTabbyWalkthrough();
      gridTabbyClickTimerRef.current = null;
    }, 210);
  }, [openGridTabbyWalkthrough, gridTabbyHidden, gridTabbyHiding]);

  const handleGridTabbyDoubleClick = useCallback(() => {
    hideGridTabbyAssistant();
  }, [hideGridTabbyAssistant]);
  ...
  useEffect(() => {
    ...
    const showChordsPanel = tabbyTourActiveTarget === "chords" && standard;

    setInstrumentOpen(showInstrumentPanel);
    setTuningOpen(showTuningPanel);
    setInsertOpen(showInsertPanel);
    if (standard) setChordsOpen(showChordsPanel);
  }, [
    isTabbyTourActive,
    tabbyTourActiveTarget,
    setInstrumentOpen,
  ...
  useEffect(() => {
    ...
    setTuningOpen(false);
    setInsertOpen(false);
    if (standard) setChordsOpen(false);
  }, [isTabbyTourActive, setInstrumentOpen, setTuningOpen, setInsertOpen, setChordsOpen, standard]);
  ...
  useEffect(
    () => () => {
      ...
      if (gridTabbyClickTimerRef.current) clearTimeout(gridTabbyClickTimerRef.current);
    },
    []
  );
  ...
  async function exportImagesNow() {
    if (!canExportPngTabs) {
      showMembershipGateToast(editorHasMembership ? "creator-export" : "export-image");
      return;
    }
    ...
    >
      ...
      {isTabbyTourActive ? (
        tabbyTourSpotlightRect && tabbyTourSpotlightRect.width > 0 && tabbyTourSpotlightRect.height > 0 ? (
          <>
            <div
              className="tabby-tour-dim-layer"
              aria-hidden="true"
          ...
          <div className="tabby-tour-dim-layer" aria-hidden="true" style={{ inset: 0 }} />
        )
      ) : null}
        ...
        {settingsOpen && (
          ...
          >
            ...
            <div style={{ ...settingsAccordionCardStyle(shortcutsOpen), order: 1 }}>
              ...
              {shortcutsOpen && (
                <div
                  style={settingsExpandedContentStyle}
                >
                            ...
                            {availableArtistNames.map((name) => {
                              ...
                              return (
                                <button
                                  key={name}
                                  type="button"
                                  className="tabstudio-editor-option"
      ...
      >
        ...
        {supText && (
          ...
          >
            ...
            {showGridTabbyOnboarding && (!gridTabbyHidden || gridTabbyHiding) && typeof document !== "undefined"
              ? createPortal(
                  <div
                    style={{
                      position: "fixed",
                      ...
                      {activeGridTabbyTooltipMode === "tour" && (
                        ...
                        >
                          ...
                          <span className="tabby-tour-step-indicator">
                            Step {tourStep} of {tabbyTourSteps.length}
                          </span>
                          ...
                          >
                            ...
                            {isFinalTabbyTourStep ? (
                              <button
                                className="tabby-tour-action-primary"
                                type="button"
                      ...
                      >
                        <div style={{ ...card, padding: 0, overflow: "hidden" }}>
                          ...
                          >
                            ...
                            <span style={{ fontSize: 12, opacity: 0.95 }}>{pdfSettingsOpenSection === "rows" ? "▲" : "▼"}</span>
                          </button>
                        ...
                        <div style={{ ...card, padding: 0, overflow: "hidden" }}>
                          ...
                          >
                            ...
                            <span style={{ fontSize: 12, opacity: 0.95 }}>{pdfSettingsOpenSection === "text" ? "▲" : "▼"}</span>
                          </button>
                        ...
                        <div style={{ ...card, padding: 0, overflow: "hidden" }}>
                          ...
                          >
                            ...
                            <span style={{ fontSize: 12, opacity: 0.95 }}>{pdfSettingsOpenSection === "song" ? "▲" : "▼"}</span>
                          </button>
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ ...card, padding: 0, overflow: "hidden" }}>
                        ...
                        >
                          <span>Row Settings</span>
                          <span style={{ fontSize: 12, opacity: 0.95 }}>{imageSettingsOpenSection === "rows" ? "▲" : "▼"}</span>
                        </button>
                      ...
                      <div style={{ ...card, padding: 0, overflow: "hidden" }}>
                        ...
                        >
                          ...
                          <span style={{ fontSize: 12, opacity: 0.95 }}>{tapSyncOpen ? "▲" : "▼"}</span>
                        </button>
                        {tapSyncOpen && (
                          <div style={{ padding: 8, borderTop: `1px solid ${THEME.border}`, display: "grid", gap: 10 }}>
                      ...
                      <div style={{ ...card, padding: 0, overflow: "hidden" }}>
                        ...
                        >
                          ...
                          <span style={{ fontSize: 12, opacity: 0.95 }}>{imageSettingsOpenSection === "background" ? "▲" : "▼"}</span>
                        </button>
                      ...
                      <div style={{ ...card, padding: 0, overflow: "hidden" }}>
                        ...
                        >
                          <span>Text Settings</span>
                          <span style={{ fontSize: 12, opacity: 0.95 }}>{imageSettingsOpenSection === "text" ? "▲" : "▼"}</span>
                        </button>
                      ...
                      <div style={{ ...card, padding: 0, overflow: "hidden" }}>
                        ...
                        >
                          <span>Song Details</span>
                          <span style={{ fontSize: 12, opacity: 0.95 }}>{imageSettingsOpenSection === "details" ? "▲" : "▼"}</span>
                        </button>
